...
def _build_search_queries(data: Dict[str, Any], is_dub: bool) -> List[str]:
    ...
    queries = [q for q in [anikii_id_eng, anikii_id_rom] if q]
    
    # Add base and sanitized variants
